...
| 4 | 2026-02-07 | **Performance optimizations (auto-adaptive)**: Created `src/utils.py` with 3 hardware adaptation helpers. Auto-detect MPS/CUDA/CPU. AMP mixed precision + DataLoader workers. Vectorized windowing via `sliding_window_view`. 13 new tests in `test_utils.py`. |
